...
public class ExceptionHandlerAdvice {
    ...
    //this is where I handle if a user does not provide Username or Password to the HTTP Basic
    //auth, check the message returned in the third argument of the Result
